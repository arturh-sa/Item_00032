          ...
          <TableBody>
            {filteredApplications.map((application) => (
              <TableRow key={application.id}>
                ...
                <TableCell>
                  <Badge variant={statusVariantMap[application.status] as any} className="pointer-events-none">
                    {application.status}
                  </Badge>
                </TableCell>
      ...
      <AlertDialog open={deleteDialogOpen} onOpenChange={setDeleteDialogOpen}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              This action cannot be undone. This will permanently delete the application and remove it from our servers.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
